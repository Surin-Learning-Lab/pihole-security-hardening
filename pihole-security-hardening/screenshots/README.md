...
| ![Lists](./02-lists-configured.png) | Lists page showing the four HaGeZi lists | 02-blocklist-strategy.md |
| ![Gravity Count](./03-gravity-count.png) | Terminal output of `sudo pihole -g` showing ~312k domains | 02-blocklist-strategy.md |
